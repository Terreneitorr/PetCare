...
import com.tuapp.petcare.features.vet.presentation.screens.VetDashboardScreen
...
@Serializable object VetDashboardRoute
...
fun AppNavigation(
    ...
    NavHost(
        ...
        startDestination = when {
            ...
            userRole == UserRole.VET -> VetDashboardRoute
            else                     -> PetListRoute
        }
    ) {
